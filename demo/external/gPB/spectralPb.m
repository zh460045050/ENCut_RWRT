function [sPb] = spectralPb(mPb, times, salmap, orig_sz, outFile, nvec)
...
if nargin<6, nvec = 17; end
if nargin<5, outFile = '';end
if nargin<4, orig_sz = size(mPb); end
...
% build the pairwise affinity matrix   %è°±è?ç±»ç?æ³?Spectral Clustering)
...
[EigVect, EigVal] = doENspb(W, times, nvec + 1, salmap);
