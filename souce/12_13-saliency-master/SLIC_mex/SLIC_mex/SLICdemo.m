...
img = imread('/Users/zhulei/Documents/study/C Work/nodeRW/nodeRW/pictures/147091.jpg');
tic;
[labels, numlabels] = slicmex(img,350,20);%numlabels is the same as number of superpixels
toc;
labelss = DrawContoursAroundSegments_EX(img, labels);
sup_num = max(max(labels));
sup_num
figure(1);imshow(labelss);

%figure(1);imshow(result_show);
